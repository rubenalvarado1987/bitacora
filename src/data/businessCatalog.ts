...
const sharedEntrySections: TemplateSection[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "lavado_dientes", label: "Lavado de dientes", type: "select", options: ["Sí", "No"] },
      { id: "deposiciones", label: "Deposiciones", type: "select", options: ["Sí", "No"] },
      {
        id: "deposiciones_estado",
        label: "Estado de deposiciones",
        type: "select",
        options: ["Normal", "Líquida"],
        dependsOn: { fieldId: "deposiciones", value: "Sí" },
      },
      {
        id: "deposiciones_cantidad",
        label: "Cantidad de deposiciones",
        type: "select",
        options: ["S (poca)", "M (normal)", "L (mucha)"],
        dependsOn: { fieldId: "deposiciones", value: "Sí" },
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "text",
        dependsOn: { fieldId: "tiene_prescripcion", value: "Sí" },
      },
      {
      ...
      { id: "prescripcion", label: "Prescripción médica (foto)", type: "photo" },
    ],
  },
  {
    id: "extras",
